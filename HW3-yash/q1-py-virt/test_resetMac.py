...
def resetMac(domName,iface,curr_mac,new_mac):
...
resetMac(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4])
#resetMac('VM2-yk','eth1','52:54:00:4b:ad:6d','52:54:00:9a:49:9b')